# daily-progress-indicator Specification

## Purpose
Define os requisitos para exibição do progresso diário de adesão às refeições com barra de progresso para qualquer data selecionada.
