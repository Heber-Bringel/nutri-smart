    ...
    <div ref={chartRef} style={{ width: '100%', height: 400, background: 'var(--color-surface)', position: 'relative', padding: '10px' }}>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 20, right: 30, left: 10, bottom: 10 }}>
          ...
          <Line yAxisId="adesao" type="monotone" dataKey="adesao" name="Adesão (%)" stroke="#3b82f6" strokeWidth={2} isAnimationActive={false} strokeDasharray="5 5" dot={{ r: 3, strokeWidth: 0, fill: '#3b82f6' }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
