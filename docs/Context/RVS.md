 ...
 ### Framework TELOS — Análise Completa de Viabilidade (Escopo Ampliado)
 ...
 **Local/Data:** Piripiri - PI, Junho de 2026
 ...
 Nesta versão revisada (v1.1), o escopo do MVP foi estendido para além dos cálculos básicos e planos alimentares, englobando a gestão completa da rotina clínica: **Registro Histórico de Medidas Corporais**, **Anotações Clínicas Privadas**, **Emissão de Relatórios Consolidados em PDF** e **Agenda de Consultas Integrada**.
 ...
 * As novas funcionalidades de relatório e agenda utilizam bibliotecas de código aberto e recursos nativos do Supabase, não gerando custos adicionais para o MVP.
 ...
 * **Sprint 5 — Polimento e Entrega (Semanas 11-12):** Validação de responsividade mobile (360px), correção de bugs e fechamento da documentação.
 ...
 | :--- | :--- | :--- |
 | **T — Técnica** | **VIÁVEL** | A adoção de processamento no cliente para relatórios (PDF) preserva as limitações do Supabase Free Tier. |
